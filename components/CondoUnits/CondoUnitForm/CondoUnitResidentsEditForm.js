...
const CondoUnitResidentsEditForm = () => {
      ...
      const handleFormSubmit = async (e) => {
            ...
            try {
                  ...
                  const response = await axios.put(
                        `/api/update/updateResidentsCondoUnit/${id}`,
                        {
      ...
      const handleFetchCondoUnitData = async () => {
            const condoUnitData = await fetchCondoUnitDataById(id);
            const resident = condoUnitData.residents.map(resident => resident.residentId);
            ...
            <section className="sectionContainer">
                  ...
                  {isModalOpen && (
                        <CustomModal
                              ...
                              modalDescription="Os residentes relacionados à unidade foram editados."
...
export default CondoUnitResidentsEditForm;
